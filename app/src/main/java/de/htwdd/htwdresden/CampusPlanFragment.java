...
/**
 * Fragment für die Campusübersicht
 *
 * @author Kay Förster
 */
public class CampusPlanFragment extends Fragment {
    ...
    private void zoomImageFromThumb(final View thumbView, @DrawableRes int imageResId) {
        ...
        mLayout.findViewById(R.id.container).getGlobalVisibleRect(finalBounds, globalOffset);
